...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.current) {
      ...
      const contact = formData.get("from_contact");
      const subject = formData.get("subject");
      const message = formData.get("message");

      const whatsappMessage = `Hello!%0A%0AName: ${name}%0AContact Number: ${contact}%0ASubject: ${subject}%0AMessage: ${message}`;
      const whatsappUrl = `https://wa.me/<+918778587429>?text=${whatsappMessage}`;
    ...
    <Container>
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInput placeholder="Your Contact Number" name="from_contact" required />
